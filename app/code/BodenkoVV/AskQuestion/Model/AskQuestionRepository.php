...
use BodenkoVV\AskQuestion\Api\Data\AskQuestionInterfaceFactory;
use BodenkoVV\AskQuestion\Api\Data\AskQuestionSearchResultsInterfaceFactory;
use BodenkoVV\AskQuestion\Api\AskQuestionRepositoryInterface;
use BodenkoVV\AskQuestion\Model\ResourceModel\Question as ResourceAskQuestion;
use BodenkoVV\AskQuestion\Model\ResourceModel\Question\CollectionFactory as AskQuestionCollectionFactory;
...
class AskQuestionRepository implements AskQuestionRepositoryInterface
{
     ...
     * @param QuestionFactory $askQuestionFactory
//     * @param QuestionCollectionFactory $askQuestionCollectionFactory
...
//        $this->askQuestionCollectionFactory = $askQuestionCollectionFactory;
     ...
     * @return \BodenkoVV\AskQuestion\Model\ResourceModel\AskQuestion\Collection
     */
    public function getList(\Magento\Framework\Api\SearchCriteriaInterface $criteria)
    {
        ...
        foreach ($collection as $askQuestionModel) {
            ...
            $this->dataObjectHelper->populateWithArray(
                ...
                'BodenkoVV\AskQuestion\Api\Data\AskQuestionInterface'
            );
